...
## Requisitos:
      ...
      ### Reserva de actividades:
        ...
        -	El sistema no permitirá que un usuario realice una reserva para más de 10 personas en una actividad 
...
## PDF mockups: 
  'GrandAventures mockups.pdf'

## Storyboard:
    https://www.figma.com/proto/tLkOYybRyv4sexzZ6YwQBl/Activity-Web?node-id=333-530&p=f&viewport=292%2C216%2C0.18&t=I3Xprb6hmbnbc88z-1&scaling=min-zoom&content-scaling=fixed&page-id=131%3A1061
...
## Templates:
  •	header.html -> index.html, activities.html, activity-information.html, reservation-information.html y user-activities.html
  •	footer.html -> index.html, activities.html, activity-information.html, reservation-information.html y user-activities.html
